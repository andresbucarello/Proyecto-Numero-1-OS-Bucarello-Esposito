...
public class HP extends javax.swing.JFrame {
    ...
    private void updateValues() {
        ...
        values[0] = countNonNullEmployees(this.app.getEmpresaHP().getProductoresPB());
        values[1] = countNonNullEmployees(this.app.getEmpresaHP().getProductoresCPU());
        values[2] = countNonNullEmployees(this.app.getEmpresaHP().getProductoresRAM());
        values[3] = countNonNullEmployees(this.app.getEmpresaHP().getProductoresFA());
        values[4] = countNonNullEmployees(this.app.getEmpresaHP().getProductoresTG());
        values[5] = countNonNullEmployees(this.app.getEmpresaHP().getEnsambladores());
    }
                    ...
                    try {
                        ...
                        SwingUtilities.invokeLater(new Runnable() {
                            ...
                            public void run() {
                                ...
                                almacenCPU
                                        .setText(String.valueOf(app.getEmpresaHP().getAlmacen().getComponentes()[1]));
                                almacenRAM
                                        .setText(String.valueOf(app.getEmpresaHP().getAlmacen().getComponentes()[2]));
                                almacenFA
                                        .setText(String.valueOf(app.getEmpresaHP().getAlmacen().getComponentes()[3]));
                                almacenTG
                                        .setText(String.valueOf(app.getEmpresaHP().getAlmacen().getComponentes()[4]));
                                almacenEnsamblador
                                        .setText(String.valueOf(app.getEmpresaHP().getAlmacen().getComponentes()[5]));

                                projectManagerStatus
                                        .setText(app.getEmpresaHP().getProjectManager().getEstadoActual());

                                diasRestantes.setText(
                                        String.valueOf(app.getEmpresaHP().getDiasParaEntrega()));

                                contadorDiasDeLaSimulacion.setText(String.valueOf(app.getEmpresaHP().getDias()));

                                strikeCounter.setText(String
                                        .valueOf(app.getEmpresaHP().getProjectManager().getStrikes()));
                                cashPenality.setText(String.valueOf(Integer.parseInt(strikeCounter.getText()) * 100));
                                directorStatus.setText(app.getEmpresaHP().getDirector().getEstadoActual());

                                

                                computadorasNormales.setText(
                                        String.valueOf(app.getEmpresaHP().getComputadorasNormales())
                                );
                                computadorasTG.setText(
                                        String.valueOf(app.getEmpresaHP().getComputadorasTG())
                                );

                                

                                ganancia.setText(formatNumberAsK((int) app.getEmpresaHP().getIngresos() -  (int) app.getEmpresaHP().getCostos()));
                                costos.setText(formatNumberAsK((int) app.getEmpresaHP().getCostos()));
                                ingresos.setText(formatNumberAsK((int) app.getEmpresaHP().getIngresos()));
    ...
    private void initializeValues() {
        if (this.app.getEmpresaHP() != null) {
            this.maxEmployees = this.app.getEmpresaHP().getCantidadTrabajadoresMaximos();
            this.actualEmployees = this.app.getEmpresaHP().getCantidadTrabajadoresActuales();
            this.scriptsValues
    ...
    private void initComponents() {
        ...
        disponibilidadAlmacen.setForeground(new java.awt.Color(0, 204, 255));
        ...
        jpanelAlmacenRAMLayout.setVerticalGroup(
            ...
            .addGroup(jpanelAlmacenRAMLayout.createSequentialGroup()
                ...
                .addGroup(jpanelAlmacenRAMLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(almacenRAM)
                    .addComponent(animationsTitle1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
        ...
        jpanelAlmacenTGLayout.setVerticalGroup(
            ...
            .addGroup(jpanelAlmacenTGLayout.createSequentialGroup()
                ...
                .addGroup(jpanelAlmacenTGLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(plotTwistTitle1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
        ...
        textCantidadTrabajadores.setForeground(new java.awt.Color(0, 204, 255));
        ...
        decreaseAnimation.setBackground(new java.awt.Color(0, 153, 255));
        ...
        increaseAnimation.setBackground(new java.awt.Color(0, 153, 255));
        ...
        increaseAssembler.setBackground(new java.awt.Color(0, 153, 255));
        ...
        decreaceAssembler.setBackground(new java.awt.Color(0, 153, 255));
        ...
        increasePlotTwist.setBackground(new java.awt.Color(0, 153, 255));
        ...
        decreacePlotTwist.setBackground(new java.awt.Color(0, 153, 255));
        ...
        increaseScripts.setBackground(new java.awt.Color(0, 153, 255));
        ...
        decreaseScripts.setBackground(new java.awt.Color(0, 153, 255));
        ...
        increaseScenary.setBackground(new java.awt.Color(0, 153, 255));
        ...
        decreaseScenary.setBackground(new java.awt.Color(0, 153, 255));
        ...
        decreaseDubbing.setBackground(new java.awt.Color(0, 153, 255));
        ...
        increaseDubbing.setBackground(new java.awt.Color(0, 153, 255));
        ...
        driveTitle11.setForeground(new java.awt.Color(0, 204, 255));
        ...
        driveTitle14.setForeground(new java.awt.Color(0, 204, 255));
        ...
        driveTitle15.setForeground(new java.awt.Color(0, 204, 255));
        ...
        driveTitle.setForeground(new java.awt.Color(0, 204, 255));
        ...
        btn_nuevo_pedido.setBackground(new java.awt.Color(0, 0, 102));
        ...
        btn_nuevo_almacen.setBackground(new java.awt.Color(0, 0, 102));
        ...
        btn_reporte.setBackground(new java.awt.Color(0, 0, 102));
        ...
        btn_cargar_guardar.setBackground(new java.awt.Color(0, 204, 255));
        ...
        jPanel1.add(btn_cargar_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 0, 180, 40));

        btn_nueva_ruta.setBackground(new java.awt.Color(0, 0, 102));
        ...
        jPanel1.add(btn_nueva_ruta, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 0, 160, 40));
